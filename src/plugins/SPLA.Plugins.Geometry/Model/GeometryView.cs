...
internal sealed class GeometryView
{
    ...
    /// <summary>Whether renders of this view carry the edge rulers — the labelled scales of distance
    /// from each edge of the box being edited — or null to follow the project's <c>edge_rulers</c>
    /// setting. It lives on the view for the same reason <see cref="Grid"/> does: an instrument picked
    /// up once stays in hand while the model works here.</summary>
    public bool? EdgeRulers { get; set; }
