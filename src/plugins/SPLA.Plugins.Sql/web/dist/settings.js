(function(){"use strict";try{if(typeof document<"u"){var a=document.createElement("style");a.appendChild(document.createTextNode(".cred-slot[data-v-17c11f13]{min-width:0;flex:1}.w-260[data-v-17c11f13]{width:260px}.list-panel{display:flex;flex-direction:column;gap:var(--gap, 10px);--card-bd: 1px solid var(--border, #444);--card-bg: var(--panel, transparent);--card-r: var(--radius, 6px)}.list-empty{color:var(--muted, #888);font-size:var(--fs-sm, 12px);padding:4px 0;font-style:italic}.list-card{border:var(--card-bd);border-radius:var(--card-r);background:var(--card-bg)}.list-card-head{display:flex;align-items:center;gap:var(--gap, 10px);padding:var(--pad, 12px);cursor:pointer}.list-card-body{padding:0 var(--pad, 12px) var(--pad, 12px);display:flex;flex-direction:column;gap:var(--gap, 10px)}.list-panel.flat{gap:0;--card-bd: 0;--card-bg: transparent;--card-r: 0}.list-panel.flat>.list-card+.list-card{border-top:1px solid var(--border, #444)}.list-panel.flat>.list-add{margin-top:var(--gap, 10px)}.list-add{align-self:flex-start;background:transparent;color:var(--muted, #888);border:1px solid var(--border, #444);border-radius:var(--radius-sm, 5px);padding:6px 12px;font-weight:600;font-size:inherit;font-family:inherit;cursor:pointer}.list-add:hover:not(:disabled){opacity:.9}.list-add:disabled{opacity:.5;cursor:default}.list-add-glyph{margin-right:5px;opacity:.8}.gbtn{display:inline-flex;align-items:center;justify-content:center;gap:3px;background:transparent;border:1px solid transparent;color:var(--muted, #888);border-radius:var(--radius-sm, 5px);padding:2px 6px;min-width:22px;height:22px;font-size:var(--fs-sm, 12px);line-height:1;cursor:pointer;font-family:inherit}.gbtn:hover:not(:disabled){color:var(--text, inherit);border-color:var(--border, #444);background:var(--elevated, transparent)}.gbtn:disabled{opacity:.45;cursor:default}.gbtn-danger:hover:not(:disabled){color:var(--danger, #e05555);border-color:var(--danger, #e05555);background:transparent}.gbtn.on{color:var(--accent, inherit)}.gbtn-text{padding:2px 8px;font-size:var(--fs-xs, 11px);white-space:nowrap}.sql-set[data-v-b3a9c92d]{display:flex;flex-direction:column;gap:var(--gap, 10px);font-size:var(--fs-sm, 12px);color:var(--text, inherit)}.muted[data-v-b3a9c92d]{color:var(--muted, #888)}.row[data-v-b3a9c92d]{display:flex;gap:8px;align-items:center;flex-wrap:wrap}.grow[data-v-b3a9c92d]{flex:1}.name[data-v-b3a9c92d]{font-size:var(--fs-sm, 12px)}.sum[data-v-b3a9c92d]{overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.w-70[data-v-b3a9c92d]{width:70px}.w-90[data-v-b3a9c92d]{width:90px}.w-130[data-v-b3a9c92d]{width:130px}.w-140[data-v-b3a9c92d]{width:140px}.w-160[data-v-b3a9c92d]{width:160px}.w-220[data-v-b3a9c92d]{width:220px}.w-400[data-v-b3a9c92d]{width:400px}.chk[data-v-b3a9c92d]{cursor:pointer}.chk input[data-v-b3a9c92d]{height:auto}label[data-v-b3a9c92d]{display:flex;gap:6px;align-items:center}input[data-v-b3a9c92d],select[data-v-b3a9c92d]{height:24px;padding:2px 6px;color:var(--text, inherit);background:var(--bg, transparent);border:1px solid var(--border, #444);border-radius:var(--radius-sm, 5px);font-family:inherit;font-size:inherit}button[data-v-b3a9c92d]:not(.gbtn){padding:2px 10px;color:var(--text, inherit);background:var(--panel, transparent);border:1px solid var(--border, #444);border-radius:var(--radius-sm, 5px);cursor:pointer;font-size:inherit}button[data-v-b3a9c92d]:not(.gbtn):hover:not(:disabled){border-color:var(--muted, #888)}button[data-v-b3a9c92d]:not(.gbtn):disabled{opacity:.5;cursor:default}")),document.head.appendChild(a)}}catch(r){console.error("vite-plugin-css-injected-by-js",r)}})();
/**
* @vue/shared v3.5.39
...
(e.charCodeAt(2) > 122 || e.charCodeAt(2) < 97), _n = (e) => e.startsWith("onUpdate:"), oe = Object.assign, Zn = (e, t) => {
  const n = e.indexOf(t);
  n > -1 && e.splice(n, 1);
}, hr = Object.prototype.hasOwnProperty, H = (e, t) => hr.call(e, t), M = Array.isArray, at = (e) => Wt(e) === "[object Map]", xt = (e) => Wt(e) === "[object Set]", xs = (e) => Wt(e) === "[object Date]", F = (e) => typeof e == "function", ee = (e) => typeof e == "string", Se = (e) => typeof e == "symbol", K = (e) => e !== null && typeof e == "object", si = (e) => (K(e) || F(e)) && F(e.then) && F(e.catch), ii = Object.prototype.toString, Wt = (e) => ii.call(e), gr = (e) => Wt(e).slice(8, -1), ri = (e) => Wt(e) === "[object Object]", es = (e) => ee(e) && e !== "NaN" && e[0] !== "-" && "" + parseInt(e, 10) === e, It = /* @__PURE__ */ Qn(
...
const fi = (e) => !!(e && e.__v_isRef === !0), k = (e) => ee(e) ? e : e == null ? "" : M(e) || K(e) && (e.toString === ii || !F(e.toString)) ? fi(e) ? k(e.value) : JSON.stringify(e, ui, 2) : String(e), ui = (e, t) => fi(t) ? ui(e, t.value) : at(t) ? {
...
function gi(e) {
  ...
  for (; s; ) {
    const i = s.prevDep;
    s.version === -1 ? (s === n && (n = i), rs(s), Or(s)) : t = s, s.dep.activeLink = s.prevActiveLink, s.prevActiveLink = void 0, s = i;
  }
...
class os {
  ...
  track(t) {
    if (!Y || !xe || Y === this.computed)
      return;
    let n = this.activeLink;
    if (n === void 0 || n.sub !== Y)
      n = this.activeLink = new Ar(Y, this), Y.deps ? (n.prevDep = Y.depsTail, Y.depsTail.nextDep = n, Y.depsTail = n) : Y.deps = Y.depsTail = n, bi(n);
...
const Ln = /* @__PURE__ */ new WeakMap(), rt = /* @__PURE__ */ Symbol(
  ""
), Kn = /* @__PURE__ */ Symbol(
  ""
), Ut = /* @__PURE__ */ Symbol(
...
function Le(e, t, n, s, i, r) {
  ...
  if (ss(), t === "clear")
    ...
    if (c && n === "length") {
      const a = Number(s);
      o.forEach((h, E) => {
        (E === "length" || E === Ut || !Se(E) && E >= a) && l(h);
      });
    } else
      switch ((n !== void 0 || o.has(void 0)) && l(o.get(n)), d && l(o.get(Ut)), t) {
        case "add":
          c ? d && l(o.get("length")) : (l(o.get(rt)), at(e) && l(o.get(Kn)));
          break;
        case "delete":
          c || (l(o.get(rt)), at(e) && l(o.get(Kn)));
          break;
        case "set":
          at(e) && l(o.get(rt));
          break;
...
function ct(e) {
  ...
  return t === e ? t : (le(t, "iterate", Ut), /* @__PURE__ */ ye(e) ? t : t.map(we));
}
function xn(e) {
  return le(e = /* @__PURE__ */ U(e), "iterate", Ut), e;
}
function Re(e, t) {
  return /* @__PURE__ */ ke(e) ? gt(/* @__PURE__ */ ot(e) ? we(t) : t) : we(t);
}
const Pr = {
  __proto__: null,
  [Symbol.iterator]() {
...
function je(e, t, n, s, i, r) {
  ...
  o !== e && (l ? d = function(h, E) {
    return n.call(this, Re(e, h), E, e);
  } : n.length > 2 && (d = function(h, E) {
...
function Cs(e, t, n, s) {
  ...
  let o = n, l = !1;
  i !== e && (r ? (l = s.length === 0, o = function(d, a, h) {
    return l && (l = !1, d = Re(e, d)), n.call(this, d, Re(e, a), h, e);
  }) : n.length > 3 && (o = function(d, a, h) {
    return n.call(this, d, a, h, e);
  }));
  const c = i[t](o, ...s);
  return l ? Re(e, c) : c;
}
...
class vi {
  ...
  get(t, n, s) {
    ...
    if ((Se(n) ? yi.has(n) : Ir(n)) || (i || le(t, "get", n), r))
      return l;
    if (/* @__PURE__ */ fe(l)) {
...
class xi extends vi {
  ...
  set(t, n, s, i) {
    ...
    if (!this._isShallow) {
      ...
      if (!/* @__PURE__ */ ye(s) && !/* @__PURE__ */ ke(s) && (r = /* @__PURE__ */ U(r), s = /* @__PURE__ */ U(s)), !o && /* @__PURE__ */ fe(r) && !/* @__PURE__ */ fe(s))
  ...
  has(t, n) {
    ...
    return (!Se(n) || !yi.has(n)) && le(t, "has", n), s;
  }
  ownKeys(t) {
    return le(
      t,
...
function Nr(e, t, n) {
  return function(...s) {
    const i = this.__v_raw, r = /* @__PURE__ */ U(i), o = at(r), l = e === "entries" || e === Symbol.iterator && o, c = e === "keys" && o, d = i[e](...s), a = n ? Bn : t ? gt : we;
    return !t && le(
      r,
      "iterate",
      c ? Kn : rt
...
function jr(e, t) {
  const n = {
    get(i) {
      ...
      e || (Fe(i, l) && le(o, "get", i), le(o, "get", l));
      const { has: c } = en(o), d = t ? Bn : e ? gt : we;
      if (c.call(o, i))
        return d(r.get(i));
      if (c.call(o, l))
        return d(r.get(l));
    ...
    get size() {
      ...
      return !e && le(/* @__PURE__ */ U(i), "iterate", rt), i.size;
    },
    has(i) {
      const r = this.__v_raw, o = /* @__PURE__ */ U(r), l = /* @__PURE__ */ U(i);
      return e || (Fe(i, l) && le(o, "has", i), le(o, "has", l)), i === l ? r.has(i) : r.has(i) || r.has(l);
    },
    forEach(i, r) {
      const o = this, l = o.__v_raw, c = /* @__PURE__ */ U(l), d = t ? Bn : e ? gt : we;
      return !e && le(c, "iterate", rt), l.forEach((a, h) => i.call(r, d(a), d(h), o));
    }
  };
  return oe(
    n,
    e ? {
      ...
      add(i) {
        const r = /* @__PURE__ */ U(this), o = en(r), l = /* @__PURE__ */ U(i), c = !t && !/* @__PURE__ */ ye(i) && !/* @__PURE__ */ ke(i) ? l : i;
        return o.has.call(r, c) || Fe(i, c) && o.has.call(r, i) || Fe(l, c) && o.has.call(r, l) || (r.add(c), Le(r, "add", c, c)), this;
      },
      set(i, r) {
        !t && !/* @__PURE__ */ ye(r) && !/* @__PURE__ */ ke(r) && (r = /* @__PURE__ */ U(r));
...
// @__NO_SIDE_EFFECTS__
function ot(e) {
  return /* @__PURE__ */ ke(e) ? /* @__PURE__ */ ot(e.__v_raw) : !!(e && e.__v_isReactive);
}
// @__NO_SIDE_EFFECTS__
function ke(e) {
...
const we = (e) => K(e) ? /* @__PURE__ */ Ht(e) : e, gt = (e) => K(e) ? /* @__PURE__ */ kn(e) : e;
// @__NO_SIDE_EFFECTS__
function fe(e) {
...
class Jr {
  ...
  set value(t) {
    const n = this._rawValue, s = this.__v_isShallow || /* @__PURE__ */ ye(t) || /* @__PURE__ */ ke(t);
...
function Ti(e) {
  return /* @__PURE__ */ ot(e) ? e : new Proxy(e, Gr);
}
class Yr {
  constructor(t, n, s) {
...
function Qr(e, t, n = q) {
  ...
  let a, h, E, O, j = !1, R = !1;
  if (/* @__PURE__ */ fe(e) ? (h = () => e.value, j = /* @__PURE__ */ ye(e)) : /* @__PURE__ */ ot(e) ? (h = () => d(e), j = !0) : M(e) ? (R = !0, j = e.some((y) => /* @__PURE__ */ ot(y) || /* @__PURE__ */ ye(y)), h = () => e.map((y) => {
    if (/* @__PURE__ */ fe(y))
      return y.value;
    if (/* @__PURE__ */ ot(y))
      return d(y);
  ...
  const w = (y) => {
    if (!(!(a.flags & 1) || !a.dirty && !y))
      if (t) {
        const T = a.run();
        if (y || i || j || (R ? T.some((be, N) => Fe(be, V[N])) : Fe(T, V))) {
          E && E();
          const be = it;
          it = a;
          try {
  ...
  return l && l(w), a = new ai(h), a.scheduler = o ? () => o(w, !1) : w, O = (y) => Xr(y, !1, a), E = a.onStop = () => {
    const y = fn.get(a);
    if (y) {
      if (c)
        c(y, 4);
...
function to(e) {
  M(e) ? dt.push(...e) : Ge && e.id === -1 ? Ge.splice(ft + 1, 0, e) : e.flags & 1 || (dt.push(e), e.flags |= 1), Ai();
}
...
function Mi(e) {
  try {
    ...
    Ie = -1, de.length = 0, Pi(), un = null, (de.length || dt.length) && Mi();
  }
}
let ce = null, Ii = null;
function an(e) {
...
function rn(e, t, n = !1) {
  const s = Zo();
  if (s || ht) {
    let i = ht ? ht._context.provides : s ? s.parent == null || s.ce ? s.vnode.appContext && s.vnode.appContext.provides : s.parent.provides : void 0;
    if (i && e in i)
      return i[e];
...
function Ri(e, t, n = q) {
  const { immediate: s, deep: i, flush: r, once: o } = n, l = oe({}, n), c = t && s || !t && r !== "post";
  let d;
  if (Bt) {
    if (r === "sync") {
      const O = io();
      ...
      return O.stop = Ve, O.resume = Ve, O.pause = Ve, O;
    }
  }
  const a = pe;
  l.call = (O, j, R) => Ce(O, a, j, R);
  let h = !1;
  r === "post" ? l.scheduler = (O) => {
    he(O, a && a.suspense);
  } : r !== "sync" && (h = !0, l.scheduler = (O, j) => {
    j ? O() : us(O);
  }), l.augmentJob = (O) => {
    t && (O.flags |= 4), h && (O.flags |= 2, a && (O.id = a.uid, O.i = a));
  };
  const E = Qr(e, t, l);
  return Bt && (d ? d.push(E) : c && E()), E;
}
function ro(e, t, n) {
...
function Vt(e, t, n, s, i = !1) {
  ...
  const r = s.shapeFlag & 4 ? En(s.component) : s.el, o = i ? null : r, { i: l, r: c } = e, d = t && t.r, a = l.refs === q ? l.refs = {} : l.refs, h = l.setupState, E = /* @__PURE__ */ U(h), O = h === q ? ni : (R) => Es(a, R) ? !1 : H(E, R), j = (R, Z) => !(Z && Es(a, Z));
  if (d != null && d !== c) {
    if (Os(t), ee(d))
  ...
  if (F(c)) {
    ...
    if (R || Z) {
      const J = () => {
        if (e.f) {
          const V = R ? O(c) ? h[c] : a[c] : j() || !e.k ? c.value : a[e.k];
          if (i)
            M(V) && Zn(V, r);
          else if (M(V))
        ...
        } else R ? (a[c] = o, O(c) && (h[c] = o)) : Z && (j(c, e.k) && (c.value = o), e.k && (a[e.k] = o));
      };
      if (o) {
        const V = () => {
          J(), dn.delete(e);
        };
        V.id = -1, dn.set(e, V), he(V, n);
      } else
        Os(e), J();
    }
  }
...
const pt = (e) => !!e.type.__asyncLoader, Vi = (e) => e.type.__isKeepAlive;
function co(e, t) {
  Di(e, "a", t);
}
function fo(e, t) {
...
function As(e, t, n, s) {
  ...
  if (o || ee(e)) {
    ...
    let c = !1, d = !1;
    l && (c = !/* @__PURE__ */ ye(e), d = /* @__PURE__ */ ke(e), e = xn(e)), i = new Array(e.length);
    for (let a = 0, h = e.length; a < h; a++)
      i[a] = t(
        c ? d ? gt(we(e[a])) : we(e[a]) : e[a],
        a,
        void 0,
        r
      );
...
function mt(e, t, n = {}, s, i) {
  if (ce.ce || ce.parent && pt(ce.parent) && ce.parent.ce) {
    ...
    return t !== "default" && (n.name = t), W(), _t(
      se,
      null,
      [ge("slot", n, s && s())],
      d ? -2 : 64
...
function Hi(e) {
  return e.some((t) => hs(t) ? !(t.type === We || t.type === se && !Hi(t.children)) : !0) ? e : null;
}
const Wn = (e) => e ? or(e) ? En(e) : Wn(e.parent) : null, Dt = (
...
), Vn = (e, t) => e !== q && !e.__isScriptSetup && H(e, t), vo = {
  get({ _: e }, t) {
    if (t === "__v_skip")
      return !0;
    ...
    if (
      // global properties
      h = c.config.globalProperties, H(h, t)
    )
      return h[t];
  },
  set({ _: e }, t, n) {
    const { data: s, setupState: i, ctx: r } = e;
    return Vn(i, t) ? (i[t] = n, !0) : s !== q && H(s, t) ? (s[t] = n, !0) : H(e.props, t) || t[0] === "$" && t.slice(1) in e ? !1 : (r[t] = n, !0);
  },
  has({
    _: { data: e, setupState: t, accessCache: n, ctx: s, appContext: i, props: r, type: o }
  }, l) {
    let c;
    return !!(n[l] || e !== q && l[0] !== "$" && H(e, l) || Vn(t, l) || H(r, l) || H(s, l) || H(Dt, l) || H(i.config.globalProperties, l) || (c = o.__cssModules) && c[l]);
  },
...
function xo(e) {
  ...
  if (qn = !0, r)
    for (const Q in r) {
      const G = r[Q], Ze = F(G) ? G.bind(n, n) : F(G.get) ? G.get.bind(n, n) : Ve, Qt = !F(G) && F(G.set) ? G.set.bind(n) : Ve, et = rl({
        get: Ze,
        set: Qt
      });
  ...
  a && Ms(a, e, "c");
  function ue(Q, G) {
    M(G) ? G.forEach((Ze) => Q(Ze.bind(n))) : G && Q(G.bind(n));
  }
  if (ue(ao, h), ue(Ni, E), ue(po, O), ue(ho, j), ue(co, R), ue(fo, Z), ue(bo, Je), ue(_o, be), ue(mo, N), ue(ji, V), ue(Ui, y), ue(go, Yt), M(Qe))
    if (Qe.length) {
  ...
  T && e.render === Ve && (e.render = T), wt != null && (e.inheritAttrs = wt), zt && (e.components = zt), Xt && (e.directives = Xt), Yt && Fi(e);
}
...
function Oo(e, t) {
  return function(s, i = null) {
    ...
    const d = r.app = {
      ...
      mount(a, h, E) {
        if (!c) {
          const O = d._ceVNode || ge(s, i);
          return O.appContext = r, E === !0 ? E = "svg" : E === !1 && (E = void 0), e(O, a, E), c = !0, d._container = a, a.__vue_app__ = d, En(O.component);
        }
      },
      onUnmount(a) {
        l.push(a);
...
let ht = null;
const Ao = (e, t) => t === "modelValue" || t === "model-value" ? e.modelModifiers : e[`${t}Modifiers`] || e[`${ve(t)}Modifiers`] || e[`${lt(t)}Modifiers`];
function Po(e, t, ...n) {
...
function ki(e, t, n = !1) {
  ...
  return !r && !l ? (K(e) && s.set(e, null), null) : (M(r) ? r.forEach((c) => o[c] = null) : oe(o, r), K(e) && s.set(e, o), o);
}
function Cn(e, t) {
  return !e || !mn(t) ? !1 : (t = t.slice(2), t = t === "Once" ? t : t.replace(/Once$/, ""), H(e, t[0].toLowerCase() + t.slice(1)) || H(e, lt(t)) || H(e, t));
}
function $s(e) {
  const {
    type: t,
  ...
  try {
    ...
    Nt.length = 0, Sn(y, e, 1), J = ge(We);
  }
  let w = J;
  if (V && R !== !1) {
    const y = Object.keys(V), { shapeFlag: T } = w;
    y.length && T & 7 && (r && y.some(_n) && (V = Ro(
      V,
      r
    )), w = bt(w, V, !1, !0));
  }
  return n.dirs && (w = bt(w, null, !1, !0), w.dirs = w.dirs ? w.dirs.concat(n.dirs) : n.dirs), n.transition && as(w, n.transition), J = w, an(Z), J;
}
const Io = (e) => {
  let t;
  for (const n in e)
...
function Wi(e, t, n) {
  const s = e[n], i = t[n];
  return n === "style" && K(s) && K(i) ? !St(s, i) : s !== i;
}
...
function Do(e, t, n, s) {
  ...
  if (
    ...
    for (const h in l)
      ...
      ((a = lt(h)) === h || !H(t, a))) && (c ? n && // for camelCase
...
function zi(e, t, n = !1) {
  ...
  if (M(r))
    ...
    for (const a in r) {
      const h = ve(a);
      if (Vs(h)) {
        const E = r[a], O = o[h] = M(E) || F(E) ? { type: E } : oe({}, E), j = O.type;
        let R = !1, Z = !0;
        if (M(j))
          for (let J = 0; J < j.length; ++J) {
            const V = j[J], w = F(V) && V.name;
            if (w === "Boolean") {
              R = !0;
              break;
            } else w === "String" && (Z = !1);
...
const ds = (e) => e === "_" || e === "_ctx" || e === "$stable", ps = (e) => M(e) ? e.map($e) : [$e(e)], jo = (e, t, n) => {
  if (t._n)
    return t;
  const s = Ft((...i) => ps(t(...i)), n);
  return s._c = !1, s;
}, Xi = (e, t, n) => {
  const s = e._ctx;
  for (const i in e) {
...
function Ko(e, t) {
  ...
  const {
  ...
  } = e, R = (f, u, p, b = null, _ = null, g = null, S = void 0, x = null, v = !!u.dynamicChildren) => {
    if (f === u)
      return;
    f && !At(f, u) && (b = Zt(f), Te(f, _, g, !0), f = null), u.patchFlag === -2 && (v = !1, u.dynamicChildren = null);
    ...
    if (v = f.el = o(
      ...
      S,
      x
    ), I && tt(f, null, b, "created"), N(v, f, f.scopeId, S, b), P) {
      for (const B in P)
        B !== "value" && !It(B) && r(v, B, null, P[B], g, b);
      "value" in P && r(v, "value", null, P.value, g), (m = P.onVnodeBeforeMount) && Me(m, b, f);
    }
    I && tt(f, null, b, "beforeMount");
    const D = Bo(_, A);
    D && A.beforeEnter(v), s(v, u, p), ((m = P && P.onVnodeMounted) || D || I) && he(() => {
      try {
        m && Me(m, b, f), D && A.enter(v), I && tt(f, null, b, "mounted");
      } finally {
      }
    }, _);
  }, N = (f, u, p, b, _) => {
    ...
    v |= f.patchFlag & 16;
    const C = f.props || q, A = u.props || q;
    let I;
    if (p && nt(p, !1), (I = A.onVnodeBeforeUpdate) && Me(I, p, u, f), P && tt(u, f, p, "beforeUpdate"), p && nt(p, !0), // #6385 the old vnode may be a user-wrapped non-isomorphic block
    // Force full diff when block metadata is unstable.
    m && (!f.dynamicChildren || f.dynamicChildren.length !== m.length) && (v = 0, S = !1, m = null), (C.innerHTML && A.innerHTML == null || C.textContent && A.textContent == null) && a(x, ""), m ? Qe(
      f.dynamicChildren,
      m,
      x,
      p,
      ...
      if (v & 16)
        ...
        for (let B = 0; B < D.length; B++) {
          const L = D[B], ne = C[L], ie = A[L];
          (ie !== ne || L === "value") && r(x, L, ne, ie, _, p);
        }
      }
      v & 1 && f.children !== u.children && a(x, u.children);
    } else !S && m == null && wt(x, C, A, p, _);
    ((I = A.onVnodeUpdated) || P) && he(() => {
      I && Me(I, p, u, f), P && tt(u, f, p, "updated");
    }, b);
  }, Qe = (f, u, p, b, _, g, S) => {
    ...
    if (Vi(f) && (x.ctx.renderer = Tt), el(x, !1, S), x.asyncDep) {
      if (_ && _.registerDep(x, ue, S), !f.el) {
        const v = x.subTree = ge(We);
        J(null, v, u, p), f.placeholder = v.el;
      }
    } else
      ue(
        x,
    ...
    const x = () => {
      if (f.isMounted) {
        let { next: C, bu: A, u: I, parent: D, vnode: B } = f;
        {
          const Oe = tr(f);
          if (Oe) {
            C && (C.el = B.el, Q(f, C, S)), Oe.asyncDep.then(() => {
              he(() => {
                f.isUnmounted || m();
              }, _);
            });
        ...
        let L = C, ne;
        nt(f, !1), C ? (C.el = B.el, Q(f, C, S)) : C = B, A && sn(A), (ne = C.props && C.props.onVnodeBeforeUpdate) && Me(ne, D, C, B), nt(f, !0);
        const ie = $s(f), Ee = f.subTree;
        f.subTree = ie, R(
          Ee,
          ie,
          ...
          _,
          g
        ), C.el = ie.el, L === null && Fo(f, ie.el), I && he(I, _), (ne = C.props && C.props.onVnodeUpdated) && he(
          () => Me(ne, D, C, B),
          _
        );
      } else {
        let C;
        const { el: A, props: I } = u, { bm: D, m: B, parent: L, root: ne, type: ie } = f, Ee = pt(u);
        nt(f, !1), D && sn(D), !Ee && (C = I && I.onVnodeBeforeMount) && Me(C, L, u), nt(f, !0);
        {
          ne.ce && ne.ce._hasShadowRoot() && ne.ce._injectChildStyle(
            ie,
            f.parent ? f.parent.type : void 0
          );
          const Oe = f.subTree = $s(f);
          R(
            null,
            Oe,
            p,
        ...
        if (B && he(B, _), !Ee && (C = I && I.onVnodeMounted)) {
          const Oe = u;
          he(
            () => Me(C, L, Oe),
            _
        ...
        (u.shapeFlag & 256 || L && pt(L.vnode) && L.vnode.shapeFlag & 256) && f.a && he(f.a, _), f.isMounted = !0, u = p = b = null;
      }
    };
    f.scope.on();
    ...
    P.i = f, P.id = f.uid, v.scheduler = () => us(P), nt(f, !0), m();
  }, Q = (f, u, p) => {
    u.component = f;
    const b = f.vnode.props;
    f.vnode = u, f.next = null, Do(f, u.props, b, p), Ho(f, u.children, p), De(), Ts(f), Ne();
  }, G = (f, u, p, b, _, g, S, x, v = !1) => {
    ...
    I & 8 ? (P & 16 && Ct(m, _, g), C !== m && a(p, C)) : P & 16 ? I & 16 ? Qt(
      m,
      C,
      p,
      b,
    ...
    if (m > C) {
      ...
      for (m = D; m <= A; m++) {
        const me = u[m] = v ? He(u[m]) : $e(u[m]);
        me.key != null && B.set(me.key, m);
      }
      let L, ne = 0;
      const ie = A - D + 1;
      let Ee = !1, Oe = 0;
      ...
      for (m = I; m <= C; m++) {
        ...
        if (me.key != null)
          ...
          for (L = D; L <= A; L++)
            if (Et[L - D] === 0 && At(me, u[L])) {
              Ae = L;
              break;
            }
        Ae === void 0 ? Te(me, _, g, !0) : (Et[Ae - D] = m + 1, Ae >= Oe ? Oe = Ae : Ee = !0, R(
          me,
          u[Ae],
          p,
          null,
      ...
      const bs = Ee ? ko(Et) : ut;
      for (L = bs.length - 1, m = ie - 1; m >= 0; m--) {
        const me = D + m, Ae = u[me], ys = u[me + 1], vs = me + 1 < P ? (
        ...
        Et[m] === 0 ? R(
          ...
          x,
          v
        ) : Ee && (L < 0 || m !== bs[L] ? et(Ae, p, vs, 2) : L--);
      }
    }
  }, et = (f, u, p, b, _ = null) => {
    const { el: g, type: S, transition: x, children: v, shapeFlag: m } = f;
    if (m & 6) {
      et(f.component.subTree, u, p, b);
      return;
    }
    if (m & 128) {
    ...
    if (b !== 2 && m & 1 && x)
      if (b === 0)
        x.persisted && !g[Fn] ? s(g, u, p) : (x.beforeEnter(g), s(g, u, p), he(() => x.enter(g), _));
      else {
        const { leave: C, delayLeave: A, afterLeave: I } = x, D = () => {
          f.ctx.isUnmounted ? i(g) : s(g, u, p);
        }, B = () => {
    ...
    if (C === -2 && (_ = !1), x != null && (De(), Vt(x, null, p, f, !0), Ne()), I != null && (u.renderCache[I] = void 0), P & 256) {
      u.ctx.deactivate(f);
      return;
    }
    const B = P & 1 && A, L = !pt(f);
    let ne;
    if (L && (ne = S && S.onVnodeBeforeUnmount) && Me(ne, u, f), P & 6)
      pr(f.component, p, b);
    else {
      if (P & 128) {
      ...
      B && tt(f, null, u, "beforeUnmount"), P & 64 ? f.type.remove(
        f,
        u,
        p,
        Tt,
      ...
      (g !== se || C > 0 && C & 64) ? Ct(
        ...
        !1,
        !0
      ) : (g === se && C & 384 || !_ && P & 16) && Ct(v, u, p), b && ms(f);
    }
    const ie = D != null && I == null;
    (L && (ne = S && S.onVnodeUnmounted) || B || ie) && he(() => {
      ne && Me(ne, u, f), B && tt(f, null, u, "unmounted"), ie && (f.el = null);
    }, p);
  }, ms = (f) => {
    ...
    if (f.shapeFlag & 1 && _ && !_.persisted) {
      const { leave: S, delayLeave: x } = _, v = () => S(p, g);
      x ? x(f.el, g, v) : v();
    } else
      g();
  }, dr = (f, u) => {
    ...
    Ds(v), Ds(m), b && sn(b), _.stop(), g && (g.flags |= 8, Te(S, f, u, p)), x && he(x, u), he(() => {
      f.isUnmounted = !0;
    }, u);
  }, Ct = (f, u, p, b = !1, _ = !1, g = 0) => {
    ...
    const u = E(f.anchor || f.el), p = u && u[oo];
    return p ? E(p) : u;
  };
  let An = !1;
  const _s = (f, u, p) => {
...
function er(e, t, n = !1) {
  ...
  if (M(s) && M(i))
    for (let r = 0; r < s.length; r++) {
      const o = s[r];
      let l = i[r];
      l.shapeFlag & 1 && !l.dynamicChildren && ((l.patchFlag <= 0 || l.patchFlag === 32) && (l = i[r] = He(i[r]), l.el = o.el), !n && l.patchFlag !== -2 && er(o, l)), l.type === Tn && (l.patchFlag === -1 && (l = i[r] = He(l)), l.el = o.el), l.type === We && !l.el && (l.el = o.el);
    }
}
function ko(e) {
  const t = e.slice(), n = [0];
...
const se = /* @__PURE__ */ Symbol.for("v-fgt"), Tn = /* @__PURE__ */ Symbol.for("v-txt"), We = /* @__PURE__ */ Symbol.for("v-cmt"), Nn = /* @__PURE__ */ Symbol.for("v-stc"), Nt = [];
let _e = null;
function W(e = !1) {
  Nt.push(_e = e ? null : []);
}
function qo() {
  Nt.pop(), _e = Nt[Nt.length - 1] || null;
}
let Kt = 1;
function Ns(e, t = !1) {
...
function ir(e) {
  return e.dynamicChildren = Kt > 0 ? _e || ut : null, qo(), Kt > 0 && _e && _e.push(e), e;
}
...
function $(e, t = null, n = null, s = 0, i = null, r = e === se ? 0 : 1, o = !1, l = !1) {
  const c = {
    __v_isVNode: !0,
    __v_skip: !0,
    type: e,
  ...
  return l ? (hn(c, n), r & 128 && e.normalize(c)) : n && (c.shapeFlag |= ee(n) ? 8 : 16), Kt > 0 && // avoid a block node from tracking itself
...
function Jo(e, t = null, n = null, s = 0, i = null, r = !1) {
  if ((!e || e === yo) && (e = We), hs(e)) {
    ...
    return n && hn(l, n), Kt > 0 && !r && _e && (l.shapeFlag & 6 ? _e[_e.indexOf(e)] = l : _e.push(l)), l.patchFlag = -2, l;
  }
  if (il(e) && (e = e.__vccOpts), t) {
    t = Go(t);
    let { class: l, style: c } = t;
    l && !ee(l) && (t.class = qt(l)), K(c) && (/* @__PURE__ */ fs(c) && !M(c) && (c = oe({}, c)), t.style = ts(c));
  }
...
function Go(e) {
  return e ? /* @__PURE__ */ fs(e) || Gi(e) ? oe({}, e) : e : null;
}
...
function yt(e = " ", t = 0) {
  return ge(Tn, null, e, t);
}
function ze(e = "", t = !1) {
  return t ? (W(), _t(We, null, e)) : ge(We, null, e);
}
function $e(e) {
...
const Ks = /* @__PURE__ */ Symbol("_vod"), dl = /* @__PURE__ */ Symbol("_vsh"), pl = /* @__PURE__ */ Symbol(""), hl = /(?:^|;)\s*display\s*:/;
function gl(e, t, n) {
...
e.charCodeAt(2) > 96 && e.charCodeAt(2) < 123, El = (e, t, n, s, i, r) => {
  const o = i === "svg";
  t === "class" ? al(e, s, o) : t === "style" ? gl(e, n, s) : mn(t) ? _n(t) || yl(e, t, n, s, r) : (t[0] === "." ? (t = t.slice(1), !0) : t[0] === "^" ? (t = t.slice(1), !1) : Ol(e, t, s, o)) ? (Js(e, t, s), !e.tagName.includes("-") && (t === "value" || t === "checked" || t === "selected") && qs(e, t, s, o, r, t !== "value")) : /* #11081 force set props for possible async custom element */ e._isVueCE && // #12408 check if it's declared prop or it's async custom element
...
const st = {
  created(e, { modifiers: { lazy: t, trim: n, number: s } }, i) {
    ...
    Ye(e, t ? "change" : "input", (o) => {
      o.target.composing || e[Be](Xs(e.value, n, r));
    }), (n || r) && Ye(e, "change", () => {
      e.value = Xs(e.value, n, r);
    }), t || (Ye(e, "compositionstart", Pl), Ye(e, "compositionend", zs), Ye(e, "change", zs));
  },
  ...
  beforeUpdate(e, { value: t, oldValue: n, modifiers: { lazy: s, trim: i, number: r } }, o) {
    if (e[Be] = vt(o), e.composing) return;
  ...
  deep: !0,
  created(e, t, n) {
    e[Be] = vt(n), Ye(e, "change", () => {
      const s = e._modelValue, i = kt(e), r = e.checked, o = e[Be];
      if (M(s)) {
...
const Ul = ["value", "placeholder"], Hl = /* @__PURE__ */ Xe({
  ...
  setup(e, { emit: t }) {
    ...
    }), on(() => n.modelValue, (l) => o == null ? void 0 : o.setValue(l)), ji(() => o == null ? void 0 : o.destroy()), (l, c) => (W(), te("div", {
      ref_key: "el",
      ref: i,
      class: "cred-slot"
    }, [
      r.value ? ze("", !0) : (W(), te("input", {
        key: 0,
        value: e.modelValue,
        class: "w-260",
        spellcheck: "false",
  ...
  for (const [s, i] of t)
    n[s] = i;
  return n;
}, Ll = /* @__PURE__ */ ar(Hl, [["__scopeId", "data-v-17c11f13"]]), Kl = ["disabled"], Bl = /* @__PURE__ */ Xe({
  __name: "AddButton",
  props: {
    label: { default: "Add" },
  ...
  setup(e, { emit: t }) {
    const n = e, s = t;
    function i() {
      n.noToggleOnClick || s("update:open", !n.open);
    }
    return (r, o) => (W(), te("div", {
      ...
      $("div", {
        ...
        mt(r.$slots, "head", { open: e.open })
      ]),
      e.open && r.$slots.body ? (W(), te("div", Jl, [
        mt(r.$slots, "body")
      ])) : ze("", !0)
    ], 2));
  }
}), Yl = ["title"], zl = /* @__PURE__ */ Xe({
  __name: "RemoveButton",
  props: {
    label: {},
  ...
  setup(e) {
    return (t, n) => (W(), te("button", {
      ...
      title: e.title,
      onClick: n[0] || (n[0] = ur((s) => t.$emit("click", s), ["stop"]))
    }, [
      e.label ? (W(), te(se, { key: 0 }, [
        yt("✕ " + k(e.label), 1)
      ], 64)) : (W(), te(se, { key: 1 }, [
        yt("✕")
      ], 64))
...
}), Xl = ["disabled", "title"], Ql = /* @__PURE__ */ Xe({
...
}), ec = { class: "sql-set" }, tc = { class: "muted" }, nc = { class: "row" }, sc = { class: "muted" }, ic = { value: "" }, rc = ["value"], oc = { class: "muted" }, lc = { class: "name" }, cc = { class: "muted" }, fc = {
  key: 0,
  class: "muted sum"
}, uc = { class: "row" }, ac = { class: "muted w-70" }, dc = ["onUpdate:modelValue"], pc = { class: "muted" }, hc = ["onUpdate:modelValue"], gc = { value: "mssql" }, mc = { value: "postgres" }, _c = { value: "sqlite" }, bc = {
  key: 0,
  class: "row"
}, yc = { class: "muted w-70" }, vc = ["onUpdate:modelValue", "placeholder"], xc = { class: "muted w-70" }, Sc = ["onUpdate:modelValue"], wc = {
  key: 1,
  class: "row"
}, Cc = { class: "muted w-70" }, Tc = ["onUpdate:modelValue", "placeholder"], Ec = { class: "row" }, Oc = {
  key: 0,
  class: "chk"
}, Ac = ["onUpdate:modelValue"], Pc = { class: "row" }, Mc = { class: "muted w-70" }, Ic = { class: "row" }, Rc = { class: "muted w-70" }, $c = ["onUpdate:modelValue", "placeholder"], Fc = { class: "row" }, Vc = { class: "muted w-70" }, Dc = ["onUpdate:modelValue", "placeholder"], Nc = { class: "row" }, jc = ["disabled", "onClick"], Uc = { class: "muted" }, Hc = /* @__PURE__ */ Xe({
  ...
  setup(e, { expose: t }) {
    ...
    ), a = /* @__PURE__ */ Ht(/* @__PURE__ */ new Set()), h = (w) => a.has(w);
    function E(w) {
      a.delete(w) || a.add(w);
    }
    function O(w) {
    ...
    async function Z(w) {
      ...
      try {
        const y = await n.api.invoke("plugin.action", {
          ...
          valueJson: JSON.stringify(J(w))
        });
        if (y.ok && y.resultJson) {
          const T = JSON.parse(y.resultJson);
          w.testStatus = T.message;
        } else
    ...
    return t({ toJson: V }), (w, y) => (W(), te("div", ec, [
      $("div", tc, k(z(X)("Named database connections available to the SQL agent. Passwords live in the secret store (Settings → Secrets); a connection only references an entry by name. Stored in the .spla project file.")), 1),
      $("div", nc, [
        $("label", null, [
          $("span", sc, k(z(X)("Default connection")), 1),
          Pe($("select", {
            "onUpdate:modelValue": y[0] || (y[0] = (T) => l.value = T)
          }, [
            $("option", ic, k(z(X)("(none)")), 1),
            (W(!0), te(se, null, As(d, (T) => (W(), te("option", {
              key: T.key,
              value: T.name
            }, k(T.name), 9, rc))), 128))
          ], 512), [
        ...
        $("label", null, [
          $("span", oc, k(z(X)("Default row limit")), 1),
          Pe($("input", {
            "onUpdate:modelValue": y[1] || (y[1] = (T) => c.value = T),
            type: "number",
            min: "1",
            class: "w-90"
          }, null, 512), [
      ...
      ge(ql, {
        ...
        default: Ft(() => [
          (W(!0), te(se, null, As(d, (T, be) => (W(), _t(Gl, {
            key: T.key,
            open: h(T.key),
            "onUpdate:open": (N) => E(T.key)
          }, {
            head: Ft(() => [
              $("b", lc, k(T.name || "(new connection)"), 1),
              $("span", cc, k(T.provider), 1),
              h(T.key) ? ze("", !0) : (W(), te("span", fc, k(O(T)), 1)),
              y[2] || (y[2] = $("span", { class: "grow" }, null, -1)),
              ge(zl, {
                label: z(X)("Remove"),
                onClick: (N) => R(be)
            ...
            body: Ft(() => [
              $("div", uc, [
                ...
                Pe($("input", {
                  "onUpdate:modelValue": (N) => T.name = N,
                  class: "w-140",
                  spellcheck: "false"
                }, null, 8, dc), [
                  [st, T.name]
                ]),
                $("span", pc, k(z(X)("Provider")), 1),
                Pe($("select", {
                  "onUpdate:modelValue": (N) => T.provider = N
                }, [
              ...
              T.provider !== "sqlite" ? (W(), te("div", bc, [
                $("span", yc, k(z(X)("Server")), 1),
                Pe($("input", {
                  "onUpdate:modelValue": (N) => T.path = N,
                ...
                Pe($("input", {
                  "onUpdate:modelValue": (N) => T.database = N,
                  class: "w-160",
                  spellcheck: "false"
                }, null, 8, Sc), [
                  [st, T.database]
                ...
                Pe($("input", {
                  "onUpdate:modelValue": (N) => T.path = N,
                  placeholder: z(X)("C:datamydb.sqlite"),
                  class: "w-400",
                  spellcheck: "false"
                }, null, 8, Tc), [
                  [st, T.path]
              ...
              T.provider !== "sqlite" ? (W(), te(se, { key: 2 }, [
                $("div", Ec, [
                  T.provider === "mssql" ? (W(), te("label", Oc, [
                    Pe($("input", {
                      type: "checkbox",
                      "onUpdate:modelValue": (N) => T.trustedConnection = N
                    }, null, 8, Ac), [
                      [Ml, T.trustedConnection]
                    ]),
                    $("span", null, k(z(X)("Windows Auth (domain)")), 1)
                  ])) : ze("", !0)
                ]),
                !T.trustedConnection || T.provider !== "mssql" ? (W(), te(se, { key: 0 }, [
                  $("div", Pc, [
                    $("span", Mc, k(z(X)("Credential")), 1),
                    ge(Ll, {
                      api: e.api,
                      modelValue: T.credential,
                      "onUpdate:modelValue": (N) => T.credential = N
                    }, null, 8, ["api", "modelValue", "onUpdate:modelValue"])
                  ]),
                  $("div", Ic, [
                    $("span", Rc, k(z(X)("User")), 1),
                    Pe($("input", {
                      "onUpdate:modelValue": (N) => T.user = N,
              ...
              $("div", Fc, [
                ...
                Pe($("input", {
                  "onUpdate:modelValue": (N) => T.description = N,
...
}), Lc = /* @__PURE__ */ ar(Hc, [["__scopeId", "data-v-b3a9c92d"]]);
function Bc(e, t) {
  var i;
