...
public static class AgentFeatureCatalog
{
    ...
    private static readonly Dictionary<string, string> DescriptionMap = new(System.StringComparer.Ordinal)
    {
        ...
        ["core.resources"] = "Read, list, and change anything by a scheme://path address (file://, sftp://, ...). Which schemes exist and what each allows is set under Resource schemes.\nresource_read resource_exists resource_list resource_write resource_delete resource_mkdir",
