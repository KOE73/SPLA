...
[ChatRuntime.cs:112](../../src/service/SPLA.Service/ChatRuntime.cs):
...
`ProjectHandlers.Open` и [ClientConnection.Resolve](../../src/service/SPLA.Service/ClientConnection.cs)
...
[SplaServiceHost.cs:220](../../src/service/SPLA.Service/SplaServiceHost.cs) делает
...
- **PFX-пароль — константа `"spla"`** ([ServiceOptions.CertPassword](../../src/service/SPLA.Service/SplaServiceHost.cs)):
