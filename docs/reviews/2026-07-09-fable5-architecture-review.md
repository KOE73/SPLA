...
([ConversationOrchestrator.cs:209](../../SPLA.Agent/ConversationOrchestrator.cs)):
...
`ChatSessionMessage` ([ChatSession.cs:51](../../SPLA.Domain/Models/ChatSession.cs)) хранит только
...
- **Один `SystemPrompt` на runtime, собранный при старте** ([AgentRuntime.cs:136](../../SPLA.Service/AgentRuntime.cs)):
