...
**Статус: в работе. Шаги 0-4 сделаны (ветка mcp/client), 1167 тестов, 1166 зелёных + 1 известный флейк (InteractiveShellTests, не мой). Остались 5 (рантайм), 6 (UI), 7 (живые прогоны).** Решения — [`ADR_20260826_service_mcp-client`](../adr/ADR_20260826_service_mcp-client.md).
