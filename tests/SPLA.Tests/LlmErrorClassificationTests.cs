...
public class LlmErrorClassificationTests
{
    ...
    public void OpenAI_style_context_400_is_ContextExhausted()
    {
        ...
        var ex = OpenAiCompatibleClient.ClassifyHttpFailure(HttpStatusCode.BadRequest, "Bad Request", body, PlainOpenAiCompatProfile.Instance);
    ...
    public void LmStudio_html_500_is_ProviderError_with_context_hint()
    {
        ...
        var ex = OpenAiCompatibleClient.ClassifyHttpFailure(HttpStatusCode.InternalServerError, "Internal Server Error", body, PlainOpenAiCompatProfile.Instance);
    ...
    {
        var ex = OpenAiCompatibleClient.ClassifyHttpFailure(HttpStatusCode.Unauthorized, "Unauthorized", "{\"error\":{\"message\":\"invalid api key\"}}", PlainOpenAiCompatProfile.Instance);
    ...
    {
        var ex = OpenAiCompatibleClient.ClassifyHttpFailure((HttpStatusCode)429, "Too Many Requests", "", PlainOpenAiCompatProfile.Instance);
